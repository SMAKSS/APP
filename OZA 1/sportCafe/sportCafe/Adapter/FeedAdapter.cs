...
using sportCafe.Interface;
using sportCafe.Model;

namespace sportCafe.Adapter
{
    ...
    public class FeedAdapter : RecyclerView.Adapter, ItemClickListener
    {
        ...
        public void OnClick(View view, int postition, bool isLongClick)
        {
            if (!isLongClick)
            {
                Intent intent = new Intent(Intent.ActionView, Android.Net.Uri.Parse(rssObject.items[postition].link));
