...
public class AppTrackerWidgetProvider extends AppWidgetProvider {
	...
	public static String ACTION_UPDATE_PAGE_FORWARD = "com.SMAli.apptracker.action.PAGE_UPDATE_FORWARD";
	public static String ACTION_UPDATE_PAGE_BACK = "com.SMAli.apptracker.action.PAGE_UPDATE_BACK";
	public static String ACTION_RESTART_SERVICE = "com.SMAli.apptracker.action.RESTART_SERVICE";
