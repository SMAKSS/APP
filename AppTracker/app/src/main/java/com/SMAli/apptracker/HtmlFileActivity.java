...
import com.SMAli.apptracker.helper.FreemiumHelper;
import com.SMAli.apptracker.util.UtilLogger;

public class HtmlFileActivity extends Activity implements OnClickListener {
	
	public static final String ACTION_ABOUT = "com.SMAli.apptracker.action.ABOUT";
	public static final String ACTION_USER_GUIDE = "com.SMAli.apptracker.action.USER_GUIDE";
