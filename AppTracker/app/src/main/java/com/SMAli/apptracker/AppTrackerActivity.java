...
import com.SMAli.apptracker.data.LoadedAppHistoryAdapter;
import com.SMAli.apptracker.data.LoadedAppHistoryEntry;
import com.SMAli.apptracker.db.AppHistoryDbHelper;
import com.SMAli.apptracker.db.AppHistoryEntry;
import com.SMAli.apptracker.db.SortType;
import com.SMAli.apptracker.helper.ActivityInfoHelper;
import com.SMAli.apptracker.helper.PreferenceHelper;
import com.SMAli.apptracker.helper.ServiceHelper;
import com.SMAli.apptracker.util.ArrayUtil;
import com.SMAli.apptracker.util.Pair;
import com.SMAli.apptracker.util.UtilLogger;

public class AppTrackerActivity extends Activity implements OnClickListener, OnItemClickListener {
    
	public static String ACTION_EXCLUDE_APPS = "com.SMAli.apptracker.action.EXCLUDE_APPS";
