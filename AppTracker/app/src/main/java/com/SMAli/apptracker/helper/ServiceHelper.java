package com.SMAli.apptracker.helper;

import java.util.List;

//import com.SMAli.apptracker.AppTrackerService;
...
public class ServiceHelper {
	...
	public static boolean checkIfAppTrackerServiceIsRunning(Context context) {
		...
		return checkIfServiceIsRunning(context, "com.SMAli.apptracker.AppTrackerService");
	}

	public static boolean checkIfUpdateAppStatsServiceIsRunning(Context context) {
		return checkIfServiceIsRunning(context, "com.SMAli.apptracker.UpdateAppStatsService");
	}
	
	private static boolean checkIfServiceIsRunning(Context context, String serviceName) {
		
		ComponentName componentName = new ComponentName("com.SMAli.apptracker", serviceName);
